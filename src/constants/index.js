...
export const introText = {
    ...
    desc: ["talent is ss", "found at the end of the sss", "effort"]
}
...
export const siteText = [
    {
        text: ["make", "1.site compliant with", "webstandard"],
    ...
    {
        text: ["make", "2.site compliant with", "react.js"],
